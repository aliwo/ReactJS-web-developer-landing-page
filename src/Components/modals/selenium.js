      ...
      <Base id="letterfly" title="Letterfly">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="1000px" height="auto" viewBox="0 0 592.745 49.209">
          <g id="" transform="translate(-124.37 -190.999)">
            ...
            <text transform="translate(152.065 218.94)" fill="#fff" fontSize="12" fontFamily="NanumBarunGothicBold, NanumBarunGothic"><tspan x="0" y="0">셀레니움 실행</tspan></text>
            <text transform="translate(285.237 218.94)" fill="#fff" fontSize="12" fontFamily="NanumBarunGothicBold, NanumBarunGothic"><tspan x="0" y="0">로그인</tspan></text>
            <text transform="translate(512.221 218.94)" fill="#fff" fontSize="12" fontFamily="NanumBarunGothicBold, NanumBarunGothic"><tspan x="0" y="0">상품 선택</tspan></text>
            <text transform="translate(396.648 218.941)" fill="#fff" fontSize="12" fontFamily="NanumBarunGothicBold, NanumBarunGothic"><tspan x="0" y="0">포인트 사용</tspan></text>
            <text transform="translate(631.224 218.941)" fill="#fff" fontSize="12" fontFamily="NanumBarunGothicBold, NanumBarunGothic"><tspan x="0" y="0">결제 완료!</tspan></text>
          </g>
        </svg>
